...
/**
 * @title TokenVaultV2
 * @dev UUPS upgradeable token vault with yield generation and pause functionality
 */
    ...
    ReentrancyGuardUpgradeable 
{
    ...
    uint256 public yieldRate; // Yield rate in basis points (annual)
    mapping(address => uint256) private _lastClaimTime;
    bool public depositsPaused;

    // Reduced storage gap (50 - 3 = 47) to account for new variables
    ...
    function initializeV2() external reinitializer(2) {
        // Grant PAUSER_ROLE to the caller (admin) for V2
